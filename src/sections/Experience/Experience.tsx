  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        technologies: ["Vue.js", "JavaScript", "Java", "Spring Boot"],
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        technologies: ["Angular", "TypeScript", "RxJS", "GraphQL", "Jasmine"],
      },
      {
        name: "Cisco Systems",
        highlights: [
        ...
        technologies: ["Angular", "TypeScript", "RxJS", "Java"],
      },
      {
        name: "Barclays",
        highlights: [
            ...
            <article className="experience__item" key={experience.company}>
              ...
              <div className="experience__projects">
                {experience.projects.map((project) => (
                  <div className="experience__project" key={project.name}>
                    <h3>{project.name}</h3>
