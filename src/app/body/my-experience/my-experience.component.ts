...
export class MyExperienceComponent {
  ...
  myExperienceList: ExperienceType[] = [
    ...
    },
    {
      ...
      technology: ['HTML', 'CSS', 'TypeScript', 'Angular 4', 'Bootstrap', 'Angular Material'],
      work: []
    },
    {
      project: 'Project 3',
      ...
      technology: ['HTML5', 'CSS3', 'JavaScript/TypeScript', 'Angular 6', 'Angular Material', 'Karma', 'Jasmine'],
      work: [
